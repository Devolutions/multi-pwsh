...
- A `.NET 10` bundled-host sample with reusable MSBuild packaging logic for the packaged `pwsh.exe` from the `PowerShell` NuGet payload lives under `dotnet\samples\BundledPwshHost\README.md`.
