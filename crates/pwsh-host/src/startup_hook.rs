...
pub(crate) const STARTUP_HOOK_ASSEMBLY_NAME: &str = "Devolutions.PowerShell.StartupHook";

pub(crate) const STARTUP_HOOK_DLL: &[u8] =
    include_bytes!("../../../dotnet/startup-hook/bin/Release/net8.0/Devolutions.PowerShell.StartupHook.dll");
